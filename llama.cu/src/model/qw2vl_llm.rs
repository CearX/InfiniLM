...
//     /// 构造 qw2vl_llm 模型
//     #[allow(dead_code)]
//     pub fn qw2vl_llm(&self, nctx: usize) -> nn::Qwen2VLmmproj<Tensor<&[u8], 2>> {
...
//     /// 插入用于 3dMRoPE 的 sin cos 表张量
//     #[allow(dead_code)]
//     pub(crate) fn insert_sin_cos_qw2vl_llm(&mut self, nctx: usize) {
//         let d = meta![self => llm_embedding_length; 1280];
//         let nh = meta![self => llm_attention_head_count; 16];
//         let dh = meta![self => llm_rope_dimension_count; d / nh]; // todo: ggus
//         let theta = meta![self => llm_rope_freq_base; 1e4];
//         let [sin, cos] = build_sin_cos(nctx, dh, theta, |pos, _| pos as _);
...
// #[allow(dead_code)]
// pub(crate) fn build_text_image_text_3d_pos_ids(
//     t: usize,
//     h: usize,
//     w: usize,
//     d_patch: usize,
